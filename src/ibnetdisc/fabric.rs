use std::{cell::{RefCell, RefMut}, collections::{hash_map::Entry, HashMap}, error::Error, ffi::CString, fmt, mem::MaybeUninit, ptr, rc::Rc};
...
impl Fabric {
    ...
    pub fn discover(&mut self) -> Result<(), FabricError> {
